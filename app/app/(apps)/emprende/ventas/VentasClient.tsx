...
import { getDashboardMetrics, getSalesInsights } from "@/actions/transaction-actions"
import { TrendingUp, TrendingDown, DollarSign, AlertCircle, ShoppingBag } from "lucide-react"
import { useRouter } from "next/navigation"
import { SalesAnalyticsContainer } from "./SalesAnalyticsContainer"
...
export default function VentasClient({ 
    ...
    return (
        <div className="pb-24 space-y-6 animate-in fade-in duration-500 max-w-6xl mx-auto">
            ...
            {/* DESKTOP PRO DASHBOARD INTELIGENTE */}
            <SalesAnalyticsContainer insights={insights} isPro={isPro} timeframe={initialTimeframe} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <div className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Venta Total Hoy (Bruta)</p>
                    </div>
                ...
                <div className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Costo Estimado Hoy</p>
                    </div>

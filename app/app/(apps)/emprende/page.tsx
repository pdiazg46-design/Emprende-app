    ...
    <DesktopLayout user={activeSession.user}>
      ...
      */}
      <div className="flex flex-col md:grid md:grid-cols-12 gap-6 md:gap-8 items-start relative w-full md:max-w-[1400px] md:mx-auto">
        ...
        <div className="md:col-span-4 w-full flex flex-col gap-6 md:sticky md:top-24 md:h-[calc(100vh-[120px])] relative z-50">
          <CartSummary />

          <div className="hidden md:flex flex-1 min-h-0 flex-col h-full bg-red-500/0">
            {/* Suspense Wrapper needs strict bounds too so the ServerComponent doesn't overflow */}

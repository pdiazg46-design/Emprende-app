...
export function DesktopSidebar({ user }: { user: any }) {
    ...
    const navItems = [
        ...
        { name: "Mi E-commerce", href: "/emprende/ecommerce", icon: ShoppingBag },
        { name: "Configuración", href: "/emprende/settings", icon: Settings },
    ];

    return (
        <aside className="hidden md:flex w-64 bg-white border-r border-slate-200 flex-col h-screen fixed left-0 top-0 z-40 print:hidden">
